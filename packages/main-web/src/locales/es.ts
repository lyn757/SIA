export default {
  ...
  common: {
    ...
    loading: 'Cargando...',
    noData: 'Sin datos',
    systemName: 'Sistema Micro Frontend',
    enter: 'Entrar',
  ...
  register: {
    ...
    usernamePlaceholder: 'Por favor ingresa nombre de usuario',
    emailPlaceholder: 'tu@correo.com',
    passwordPlaceholder: 'Ingresa contraseña',
    confirmPasswordPlaceholder: 'Confirma contraseña',
    emailCodePlaceholder: 'Ingresa código de verificación',
    phonePlaceholder: 'Opcional',
    sendCode: 'Enviar Código',
    codeSent: 'Código de verificación enviado',
    codeSendFailed: 'Error al enviar código de verificación',
    agreePrefix: 'Acepto',
    agreeToTerms: 'Acepto',
    serviceTerms: 'Términos de Servicio',
    privacyPolicy: 'Política de Privacidad',
    termsContent: 'Aquí está el contenido detallado de los términos de servicio...',
    privacyContent: 'Aquí está el contenido detallado de la política de privacidad...',
    submit: 'Registrarse',
    ...
    contactPersonPlaceholder: 'Persona de contacto de la empresa',
    contactPhone: 'Teléfono de Contacto',
    contactPhonePlaceholder: 'Teléfono de contacto de la empresa',
    companyAddress: 'Dirección de la Empresa',
    companyAddressPlaceholder: 'ej.: Calle Principal 123',
    businessScope: 'Ámbito de Negocio',
    businessScopePlaceholder: 'Opcional',
    city: 'Ciudad',
    selectCity: 'Seleccionar Ciudad',
    district: 'Distrito',
    selectDistrict: 'Seleccionar Distrito',
    street: 'Calle',
    streetPlaceholder: 'Ingresa calle',
    ...
    // Específico para contratistas
    contractorInfo: 'Información del Contratista',
    contractorType: 'Tipo de Contratista',
    team: 'Equipo',
    contractorName: 'Nombre del Contratista',
    contractorNamePlaceholder: 'Nombre de tu equipo/empresa contratista',
    ...
    hvac: 'HVAC',
    contractorPhone: 'Teléfono de Contacto',
    contractorPhonePlaceholder: 'Teléfono de contacto del contratista',
    contractorCity: 'Ciudad',
    contractorDistrict: 'Distrito',
    contractorAddress: 'Dirección',
    contractorAddressPlaceholder: 'Dirección detallada del contratista',
    contractorScope: 'Ámbito de Negocio',
    contractorScopePlaceholder: 'Describe el alcance de tus servicios de construcción'
  },
  
  // Roles
  roles: {
    designer: 'Diseñador B2B',
    designerDesc: 'Sube y vende tus diseños',
    supplier: 'Proveedor B2B',
    supplierDesc: 'Vende productos en la plataforma',
    contractor: 'Contratista B2B',
    contractorDesc: 'Toma proyectos de renovación',
    user: 'Usuario B2C',
    userDesc: 'Navega y ordena productos',
    guest: 'Invitado',
    guestDesc: 'Modo de navegación de visitante'
  },
  
  // Validación
  validation: {
    usernameRequired: 'Por favor ingresa nombre de usuario',
    usernameLength: 'El nombre de usuario debe tener al menos 3 caracteres',
    emailRequired: 'Por favor ingresa correo electrónico',
    emailFormat: 'Formato de correo inválido',
    passwordRequired: 'Por favor ingresa contraseña',
    passwordLength: 'La contraseña debe tener al menos 6 caracteres',
    confirmPasswordRequired: 'Por favor confirma la contraseña',
    passwordNotMatch: 'Las contraseñas no coinciden',
    emailCodeRequired: 'Por favor ingresa código de verificación de correo',
    phoneFormat: 'Formato de número de teléfono inválido',
    agreementRequired: 'Por favor acepta los términos de servicio y política de privacidad',
    designerNameRequired: 'Por favor ingresa nombre del diseñador/empresa',
    companyNameRequired: 'Por favor ingresa nombre de la empresa',
    contactPersonRequired: 'Por favor ingresa persona de contacto',
    contactPhoneRequired: 'Por favor ingresa teléfono de contacto',
    contractorNameRequired: 'Por favor ingresa nombre del contratista',
    contractorPhoneRequired: 'Por favor ingresa teléfono de contacto del contratista'
  },
  ...
  dashboard: {
    ...
    welcome: 'Bienvenido al Sistema Micro Frontend',
    description: 'Un sistema de arquitectura micro frontend basado en Vue 3 + Wujie',
    designerDesc: 'Herramientas de diseño profesional y gestión de plantillas para diseñadores',
    supplierDesc: 'Plataforma de gestión de proveedores para pedidos e inventario',
    userDesc: 'Interfaz de usuario B2C que proporciona excelente experiencia de usuario'
  },
  
  designer: {
    title: 'Diseñador B2B',
    app: 'Aplicación de Diseñador'
  },
  
  supplier: {
    title: 'Proveedor B2B',
    app: 'Aplicación de Proveedor'
  },
  
  contractor: {
    title: 'Contratista B2B',
    app: 'Aplicación de Contratista'
  },
  ...
  guest: {
    title: 'Modo Invitado',
    dashboard: 'Panel de Invitado',
    welcome: 'Bienvenido Invitado',
    description: 'Los invitados pueden navegar algún contenido público',
    browseProducts: 'Navegar Productos',
    browseProductsDesc: 'Ve nuestra vitrina de productos e introducción de servicios',
    aboutUs: 'Acerca de Nosotros',
    aboutUsDesc: 'Conoce nuestra cultura empresarial e historia de desarrollo',
