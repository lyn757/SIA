export default {
  ...
  login: {
    ...
    toRegister: 'Register a new account',
    registerNow: 'Register Now',
    forgotPassword: 'Forgot password?',
    orLoginWith: 'Or continue through the following methods',
  ...
  register: {
    ...
    companyAddressPlaceholder: 'Enter street address',
    businessScope: 'Business Scope',
    businessScopePlaceholder: 'Enter country',
    city: 'City',
    cityPlaceholder: 'Enter city',
    selectCity: 'Select City',
    district: 'District',
    districtPlaceholder: 'Enter state or province',
    selectDistrict: 'Select District',
    street: 'Street',
    streetPlaceholder: 'Apartment, Suite, Floor, etc',
    zipCode: 'Zip Code',
